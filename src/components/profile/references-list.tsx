...
export function ReferencesList({ references: _references, isLoading }: ReferencesListProps) {
  if (isLoading) {
    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardContent className="py-8 text-center">
          ...
          <h3 className="text-lg font-semibold mb-2">References component coming soon</h3>
